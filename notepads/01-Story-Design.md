...
- Pull the story from GitHub.
- Analyze the story, including all acceptance criteria.
- Review the `@overview.md` file for a comprehensive understanding of the overall project.
- Thoroughly search and analyze the entire codebase to determine the optimal approach for implementing the story. Pay close attention to existing patterns and conventions.
...
- The change summary MUST include:
