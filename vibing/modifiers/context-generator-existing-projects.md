...
**Purpose**: Generates all AGENT.md context files for brownfield projects by scanning existing code and analyzing the complete vibing-2.0 rules and agents directory.
...
- **Rules Directory**: Complete analysis of `vibing-2.0/rules/` directory
- **Agents Directory**: Complete analysis of `vibing-2.0/agents/` directory
...
4. **Rules and Agents Analysis**:
   - Scan all files in `vibing-2.0/rules/` directory recursively
   - Scan all files in `vibing-2.0/agents/` directory recursively
...
**Note**: The global `vibing-2.0/context/AGENT.md` file should be pre-created and will not be generated by this modifier.
...
1. **Backend Context** (`{detected-backend-dir}/AGENT.md`):
   ...
   - **Responsible Agent**: @vibing-2.0/agents/backend-engineer.md
...
2. **Frontend Context** (`{detected-frontend-dir}/AGENT.md`):
   ...
   - **Responsible Agent**: @vibing-2.0/agents/frontend-engineer.md
...
3. **Store Context** (`{detected-store-dir}/AGENT.md`):
   ...
   - **Responsible Agent**: @vibing-2.0/agents/data-engineer.md
...
4. **E2E Context** (`{detected-e2e-dir}/AGENT.md`):
   ...
   - **Responsible Agent**: @vibing-2.0/agents/test-automation-engineer.md
...
1. **Validate Generated Files**:
   ...
   - Check that all rule references exist in vibing-2.0/rules/
   - Check that all agent references exist in vibing-2.0/agents/
...
1. **Scan Rules Directory**: Read all files in `vibing-2.0/rules/` recursively
...
- `@vibing-2.0/rules/common/foundation/general-rules.md`
- `@vibing-2.0/rules/common/foundation/typescript-guidelines.md`
- `@vibing-2.0/rules/common/foundation/error-handling-guidelines.md`
- `@vibing-2.0/rules/common/testing/test-general.md`
- `@vibing-2.0/rules/common/testing/test-context.md`

**Frontend Framework Rules**:

- **React**: All `@vibing-2.0/rules/react/*.md` files
- **Solid.js**: All `@vibing-2.0/rules/solid.js/*.md` files
- **Astro**: All `@vibing-2.0/rules/astro.js/*.md` files

**UI/UX Rules (Frontend Projects)**:

- All `@vibing-2.0/rules/common/ui/*.md` files

**GraphQL/Apollo Rules**:

- If Apollo Client detected: All `@vibing-2.0/rules/apollo/*.md` files

**Backend Rules**:

- All `@vibing-2.0/rules/common/backend/*.md` files

**Data Rules**:

- All `@vibing-2.0/rules/common/data/*.md` files

**Testing Rules**:

- All `@vibing-2.0/rules/common/testing/*.md` files
...
[Reference: @vibing-2.0/rules/common/data/data-attribute-naming-conventions.md]

### TypeScript Guidelines

[Reference: @vibing-2.0/rules/common/foundation/typescript-guidelines.md]

### General Coding Standards

[Reference: @vibing-2.0/rules/common/foundation/general-rules.md]
...
- **Responsible Agent**: @vibing-2.0/agents/[agent-name].md
- **Purpose**: [Inferred from code analysis]
- **Rules**:
  - @vibing-2.0/rules/[category]/[rule-file].md
  - @vibing-2.0/rules/[category]/[rule-file].md
...
[Reference: @vibing-2.0/rules/common/testing/test-general.md]

### Test Data Management

[Reference: @vibing-2.0/rules/common/testing/test-context.md]

### E2E Testing

[Reference: @vibing-2.0/rules/common/testing/test-e2e.md]

### Framework-Specific Testing

[Reference: @vibing-2.0/rules/[framework]/[framework]-testing-guidelines.md]

## 8. Security Considerations

### Error Handling

[Reference: @vibing-2.0/rules/common/foundation/error-handling-guidelines.md]
...
- **Agent**: @vibing-2.0/agents/[agent-name].md
- **Steps**: [Inferred from code patterns]
- **Rules**: @vibing-2.0/rules/[category]/[rule-file].md
```
...
@vibing-2.0/modifiers/context-generator-existing-projects.md

# Inputs:
# - Project root: /path/to/project
# - Rules: vibing-2.0/rules/
# - Agents: vibing-2.0/agents/
