...
- **[201 High-Level Design](./201-high-level-design/)** — define the feature in plain language
- **[202 Spec Design](./202-spec-design/)** — write the Gherkin behavior scenarios
- **[203 Implementation Design](./203-implementation-design/)** — produce a codebase-grounded implementation plan
- **[204 Feature Validation](./204-feature-validation/)** — cross-artifact readiness review before coding
