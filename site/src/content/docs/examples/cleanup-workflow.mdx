...
<PromptBlock title="Prompt sequence" text={`Run 401-cleanup on the staged source changes.
Use source code cleanup only.
Do not broaden the scope unless an out-of-scope opportunity is worth explicit approval.`} />
