...
<details>
<summary>Does `npx skills add` install the worker agents too?</summary>

No. `npx skills add` installs the SpecFlow skills only. The bundled worker agents are an optional
...
<details>
<summary>When should I use 402 instead of 302?</summary>
...
<Callout tone="tip" title="Still unsure where to start?">
  Read [Getting Started](../getting-started/) and start with `201 -> 202 -> 301 -> 401`, or use `402` when the immediate problem is a failing test whose fix path is not yet clear.
</Callout>
