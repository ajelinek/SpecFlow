...
<PromptBlock title="Prompt" text={`Run 101-project-overview for a construction expense management tool targeting project managers at mid-market firms.`} />

<PromptBlock title="Prompt" text={`Run 101 — here is the pitch: [paste concept].`} />
