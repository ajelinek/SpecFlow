...
Need more prompt examples? See [`100-domain-knowledge` common prompts](/project-foundation/100-domain-knowledge/#common-prompts) for broader input patterns you can adapt before or alongside `101`.
