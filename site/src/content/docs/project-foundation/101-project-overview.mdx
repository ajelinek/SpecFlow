...
1. Pain point — the specific problem the product solves that existing solutions do not address well
2. Differentiation — direct competitors or solution categories, and how this product stands apart
3. Target users — the primary user types and their main goals when using the product
4. Key scenarios — the 3-5 most important user journeys that represent the core value of the product
5. Success metrics — how you'll know the product is succeeding, quantifiable signals preferred

## Common prompts

Need more prompt examples? See [`100-domain-knowledge` common prompts](../100-domain-knowledge/#common-prompts) for broader input patterns you can adapt before or alongside `101`.
