...
- `107` calls `@designer` three times in parallel, each a fresh invocation with a different seed bet, to get genuinely divergent UX directions, then scores them itself in Step 4.
