...
`.specflow/features/invoice-approval/overview.md`
...
`.specflow/features/invoice-approval/specs.feature`
...
`.specflow/features/invoice-approval/implementation.md`
...
- **Reference them in prompts** — tell agents to read `@.specflow/features/invoice-approval/specs.feature` before implementing
